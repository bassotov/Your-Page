...
function MarkerPopup({
  ...
  return createPortal(
    <div
      className={cn(
        "relative rounded-xl border-none bg-popover p-3 text-popover-foreground shadow-xl animate-in fade-in-0 zoom-in-95 outline-none",
        className
      )}
    >
      {closeButton && (
        <button
          type="button"
          onClick={handleClose}
          className="absolute top-1.5 right-1.5 z-10 rounded-full p-1 opacity-70 hover:opacity-100 hover:bg-muted transition-all focus:outline-none focus:ring-2 focus:ring-ring"
